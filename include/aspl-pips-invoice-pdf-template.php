...
if ( ! wp_verify_nonce( $nonce, 'aspl_pips_email_nonce' ) ) {		
	die();
}
ob_end_clean(); 
ob_start();
...
$pdf->Cell(95,5, 'Order Id : '.$order_id ,0,1,'R',0);
$pdf->Cell(95,5, '' ,0,0,'L',0);
$pdf->Cell(95,5, 'Date : '.$o_date ,0,1,'R',0);
$pdf->Cell(95,5, '' ,0,0,'L',0);
$pdf->Cell(95,5, 'Payment Method : '.$order->get_payment_method_title() ,0,1,'R',0);
